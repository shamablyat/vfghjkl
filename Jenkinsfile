        ...
        stage('Get Commit Information') {
            ...
            steps {
                script {
                    ...
                    sh 'curl -X POST -H "Content-Type: application/json" -d \'{"chat_id": "-4135540092", "text": "[💀FAILED] script is failed build failed😭! "'${message}', "disable_notification": false}\' "https://api.telegram.org/bot6441756857:AAHVQhKc1IrnYo8UsZ-lqKRz9NnktcQww3Y/sendMessage"'
                }
            }
